...
namespace KC.HMS.Web.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var loginResponse = _externalServicecs.Login(new Services.ViewModels.TokenRequestModel
                    {
                        Email = Input.Email,
                    ...
                    identity.AddClaim(new Claim("api-token", token));
